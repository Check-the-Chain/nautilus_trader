...
//!
//! The `nautilus-alpaca` crate provides integration with the Alpaca Trading and
//! Market Data APIs for trading US spot equities, with paper trading support.
//!
//! # NautilusTrader
//!
...
pub use crate::{
    ...
    websocket::client::{AlpacaTradeUpdatesWebSocketClient, AlpacaWebSocketClient},
};
